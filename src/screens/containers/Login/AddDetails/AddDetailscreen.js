  ...
  return (
    <div classname='detail-bg'>
      ...
      <form  className ="Form-Container-detail" onSubmit={handleSubmit}>
          ...
          <TextField id="standard-basic" label="Mob. Number" variant="standard"
          className="formFieldInput" 
              name="Mob"
              type="text"
              value={mobNumber}
              onChange={(e)=>setmobNumber(e.target.value)}fullWidth
            />
            </div>
      ...
      />
          ...
          className="formFieldInput" 
              ...
              type="text"
              value={College}
              onChange={(e)=>setCollege(e.target.value)}fullWidth
            />
              
          </div>
          <div className="formField-detail">
            
          <TextField id="standard-basic" label="Ambassador" variant="standard"
          className="formFieldInput" 
              name="College"
              type="text"
              value={Ambassador}
              onChange={(e)=>setAmbassador(e.target.value)}fullWidth
            />   
          </div>
        </form>
        <Button className="formFieldButton-detail" type='submit'>Continue</Button>
      </div>
      </div>
    </div>
  )
