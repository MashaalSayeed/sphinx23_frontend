...
function EventCard(props) {
  ...
  return (
    ...
    >
      <div
        className="eventE-card"
        style={{ animationDelay: animDelay }}
      >
        <div
          className="eventE-imgCon"
          style={{ background: curr.backCol }}
        >
          <img src={card.imageUrl}></img>
        </div>
        <div
          className="eventE-details"
          style={{ background: curr.backCol }}
        >
          <div
            className="eventE-left"
            style={{ color: curr.leftCol }}
          >
            <div className="eventE-title">
              {card.name}
            </div>
            {/* {card.amount != 0 && (
            ...
            <button className="eventE-register">
              Explore
            </button>
          </div>
          <div
            className="eventE-right"
            style={{ color: curr.rightCol }}
          >
